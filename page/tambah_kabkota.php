                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="tanggal_berdiri" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" data-target="#tanggal_berdiri" name="tanggal_berdiri"/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="jumlah_kelurahan" class="form-control" id="jumlah_kelurahan" value="0">
                            </div>
                            <div class="form-group">
                                <label for="jumlah_desa">Jumlah Desa</label>
                                <input type="number" name="jumlah_desa" class="form-control" id="jumlah_desa" value="0">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="deskripsi" name="deskripsi" class="form-control" rows="4" placeholder="Masukkan beberapa teks deskripsi tentang kabupaten/kota..."><strong>disini...</strong></textarea>
                            </div>
                            <div class="form-group">
