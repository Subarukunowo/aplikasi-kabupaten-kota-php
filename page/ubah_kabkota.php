<?php
include(__DIR__ . '/../api/conf/koneksi.php');
          ...
          <form id="tambahData" method="post" action="proses/kabkota/proses_ubah_kabkota.php" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="kabupaten_kota" class="form-control" id="kabupaten_kota" placeholder="Masukkan nama Kabupaten/Kota baru..." value="<?= $row['kabupaten_kota'] ?>">
              </div>

              <div class="form-group">
                <label for="pusat_pemerintahan">Pusat Pemerintahan</label>
                <input type="text" name="pusat_pemerintahan" class="form-control" id="pusat_pemerintahan" placeholder="Masukkan nama pusat pemerintahan..." value="<?= $row['pusat_pemerintahan'] ?>">
              </div>

              <div class="form-group">
                <label for="bupati_walikota">Kepala Daerah</label>
                <input type="text" name="bupati_walikota" class="form-control" id="bupati_walikota" placeholder="Masukkan nama kepala daerah..." value="<?= $row['bupati_walikota'] ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="number" name="jumlah_penduduk" class="form-control" id="jumlah_penduduk" placeholder="Masukkan jumlah penduduk..." value="<?= $row['jumlah_penduduk'] ?>">
              </div>

              <div class="form-group">
                <label for="jumlah_kecamatan">Jumlah Kecamatan</label>
                <input type="number" name="jumlah_kecamatan" class="form-control" id="jumlah_kecamatan" placeholder="Masukkan jumlah kecamatan..." value="<?= $row['jumlah_kecamatan'] ?>">
              </div>

              <div class="form-group">
                <label for="jumlah_kelurahan">Jumlah Kelurahan</label>
                <input type="number" name="jumlah_kelurahan" class="form-control" id="jumlah_kelurahan" placeholder="Masukkan jumlah kelurahan..." value="<?= $row['jumlah_kelurahan'] ?>">
              </div>

              <div class="form-group">
                <label for="jumlah_desa">Jumlah Desa</label>
                <input type="number" name="jumlah_desa" class="form-control" id="jumlah_desa" placeholder="Masukkan jumlah desa..." value="<?= $row['jumlah_desa'] ?>">
              </div>

              <div class="form-group">
                <label for="url_peta_wilayah">Link URL Peta Wilayah</label>
                <input type="url" name="url_peta_wilayah" class="form-control" id="url_peta_wilayah" placeholder="Masukkan URL peta wilayah..." value="<?= $row['url_peta_wilayah'] ?>">
              </div>
